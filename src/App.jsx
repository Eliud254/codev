...
const projectsData = [
  {
    ...
    description:
      'Rilla Voice AI transforms audio into text and PDFs into voice.',
  ...
  },
  {
    ...
    title: 'AirBnB Clone',
    description:
      'A Django-based solution leveraging search algorithms to simplify property rentals, enabling seamless listing, booking, and discovery.',
  ...
  },
  {
    ...
    title: 'TrendLens',
    description:
      'An AI-powered tool using machine learning and NLP algorithms to predict video success by analyzing trends and audience engagement.',
    technologies: [
      'JavaScript',
      'React',
      'Tailwind',
...

  {
    ...
    description:
      'A versatile online IDE supporting 10 languages with customizable themes, smart output handling',
...

  {
    ...
    description:
      'An AI-driven platform that empowers students with smart, data-backed professor ratings',
    technologies: [
      'Javascript',
      'React',
      'Next',
